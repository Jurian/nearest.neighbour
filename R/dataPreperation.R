...
#' @description This function makes several assumptions about the structure of supplied datasets. Weather data is assumed to be of the form <station, datetime, value>. Station data is assumed to be minimally of the form <station, longitude, latitude>. This function was specifially designed to merge data taken from http://www.sciamachy-validation.org/climatology/daily_data/selection.cgi
